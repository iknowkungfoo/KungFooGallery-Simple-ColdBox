<div class="row-fluid">
	<div class="span4">
		<h2>Carousel</h2>
		<p>I haven't written any JavaScript yet. By writing simple HTML using <code>data-</code> attributes, Twitter Bootstrap does the rest.</p>
	</div>
	<div class="span4">
	...
	<div class="span4">
		<h2>Just add data</h2>
		<p>Just provide some data via ColdFusion and we're up and running.</p>
		<p>Click an image to see what else can be done.</p>
	</div>
</div>